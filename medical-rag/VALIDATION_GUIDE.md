...
### Quick Syntax Check
```bash
cd /home/ashok/Desktop/RAGSYSTEM/medical-rag/backend
...
# - answer: Non-empty answer about diabetes
...
curl -X POST http://localhost:8000/ask \
  -H "Content-Type: application/json" \
  -d '{"question": "What are the stages and management of diabetic retinopathy?"}'
```
